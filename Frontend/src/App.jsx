...
// import LoginPage from './components/LoginPage.jsx'; // Remove this line
...
function App() {
  ...
  // const [isLoggedIn, setIsLoggedIn] = useState(false); // Remove this line

  // console.log('App component rendered. isLoggedIn:', isLoggedIn); // Remove this line
  ...
  switch (currentPage) {
    ...
    default:
      ...
      // if (!isLoggedIn) { // Remove this conditional block
